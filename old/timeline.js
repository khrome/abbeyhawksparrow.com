...
links.Timeline.prototype.onMouseUp = function (event) {
    ...
    if (params.customTime) {
        ...
        //jquery hacking
        var t = $(params.target);
        var e =(t.hasClass('timeline-event'))?t[0]:t.parent('.timeline-event')[0];
        var ec = (t.hasClass('timeline-event-content'))?t[0].innerText:t.parent('.timeline-event-content')[0].innerText;
        if(options.onSelect) options.onSelect(ec, e);
